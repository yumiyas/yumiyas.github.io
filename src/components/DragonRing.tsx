...
export default function DragonRing() {
    return (
        <div className="absolute inset-x-0 inset-y-0 z-30 pointer-events-none -m-8 md:-m-12">
            <motion.div
                animate={{ rotate: 360 }}
                transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
                className="w-full h-full relative"
            >
                <svg viewBox="0 0 679.709 850.333" className="w-[120%] h-[120%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible">
                    <defs>
                        <linearGradient id="dragonFire" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="#59f20d" stopOpacity="1" />
                            <stop offset="50%" stopColor="#309406" stopOpacity="0.8" />
